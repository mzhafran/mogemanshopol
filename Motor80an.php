  ...
  <body>
    ...
    <div class="row mt-5 no-gutters">
      ...
      <div class="col-md-10">
        ...
        <h4 class="text-center font-weight-bold m-4">Produk 80AN</h4>

        <div class="row mx-auto">
          <div class="card mr-2 ml-2" style="width: 16rem;">
            <img src="80an.jpg" class="card-img-top" alt="...">
            <div class="card-body bg-light">
              <h5 class="card-title ">Streling 80 Type B</h5>              
              <p class="card-text">Motor Klasik Streling 80 B</p>
           ...
           <div class="card mr-2 ml-2" style="width: 16rem;">
            <img src="80an1.jpg" class="card-img-top" alt="...">
            <div class="card-body bg-light">
              <h5 class="card-title ">Streling Old Red</h5>              
              <p class="card-text">Motor Klasik Streling O Red</p>
              <i class="fas fa-star text-warning"></i>
              <i class="fas fa-star text-warning"></i>
              <i class="fas fa-star text-warning"></i>
              <i class="fas fa-star text-warning"></i>
          ...
          <div class="card mr-2 ml-2" style="width: 16rem;">
            <img src="80an2.jpg" class="card-img-top" alt="...">
            <div class="card-body bg-light">
              <h5 class="card-title">Streling Old Type C</h5>              
              <p class="card-text">Motor Klasik Streling O C</p>
              <i class="fas fa-star text-warning"></i>
              <i class="fas fa-star text-warning"></i>
              <i class="fas fa-star text-warning"></i>
              <i class="fas fa-star text-warning"></i>
          ...
          <div class="card mr-2 ml-2" style="width: 16rem;">
            <img src="80an3.jpg" class="card-img-top" alt="...">
            <div class="card-body bg-light">
              <h5 class="card-title">Streling Classic Style</h5>              
              <p class="card-text">Motor Klasik Streling</p>
              <i class="fas fa-star text-warning"></i>
              <i class="fas fa-star text-warning"></i>
              <i class="fas fa-star text-warning"></i>
              <i class="fas fa-star text-warning"></i>
