...
<html lang="en">
  ...
  <body>
    <div class="container">
        <div id="header">
            <div id="logo">
             <h2 style="background-color:red ">DATA MOTOR</h2>
  <div class="btn-group btn-group-toggle" data-toggle="buttons">
  <label class="btn btn-secondary active">
    <input type="radio"  name="options" id="option1" checked><a href="data_user.php"> Data User</a>
  </label>
  <label class="btn btn-secondary">
    <input type="radio" name="options" id="option2"><a href="penjualan.php">Data Penjualan</a>
  </label>
   <label class="btn btn-secondary">
    <input type="radio" name="options" id="option2"><a href="toko_online.php">Home</a>
  </label>
  <label class="btn btn-secondary">
    <input type="radio" name="options" id="option2"><a href="form_inputmotor.php">Jual Motor</a>
  </label>
</div>
        </div>
        </div>
